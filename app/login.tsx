    ...
    <AppScreen scroll={false} contentClassName="justify-center px-5">
      ...
      >
        <View className="items-center gap-4">
          ...
          <View className="gap-2">
            ...
            <Text className="text-center text-[15px] leading-6 text-app-muted">
              Sign in to sync meetings, tasks, transcripts, and AI answers.
            </Text>
          </View>
        </View>
        ...
        <Card className="gap-5" padding="lg">
          {!isConfigured ? (
            <View className="flex-row gap-3 rounded-2xl border border-[#FED7AA] bg-[#FFF7ED] px-4 py-3">
              ...
              <Text className="flex-1 text-[13px] leading-5" style={{ color: colors.warning }}>
                Supabase env values are missing. Add the project URL and anon key before signing in.
              </Text>
            </View>
          ) : null}
        ...
        <View className="flex-row justify-center gap-1">
          <Text className="text-[14px] text-app-muted">New to Red Renote?</Text>
          <Link
